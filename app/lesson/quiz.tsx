...
const Quiz = ({ initialLessonId, initialLessonChallenges, initialHearts, initialPercentage, userSubscription }: Props) => {
    ...
    const [percentage, setSetPercentage] = useState(() => {
            ...
            startTransition(() => {
                upsertChallengeProgress(challenge.id)
                    .then((response) => {
                        ...
                        setSetPercentage((prev) => prev + 100 / challenges.length);
        ...
        return (
            <>
                ...
                >
                    ...
                    <h1 className=" text-xl lg:text-3xl font-bold text-neutral-700">Great job! You&apos;re completed the lesson.</h1>
                ...
                <div className=" h-full flex items-center justify-center">
                    <div className=" lg:min-h-[350px] lg:w-[600px] w-full px-6 lg:px-0 flex flex-col gap-y-12">
                        ...
                        <div>
                            ...
                            <Challenge options={options} onSelect={onSelect} status={status} selectedOption={selectedOption} disable={pending} type={challenge.type} />
                        </div>
                    </div>
                </div>
            </div>
            <Footer disable={pending || !selectedOption} status={status} onCheck={onContinue} />
        </>
    );
};
