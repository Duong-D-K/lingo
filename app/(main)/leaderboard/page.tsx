        ...
        <div className=" flex flex-row-reverse gap-[48px] px-6">
            ...
            <FeedWrapper>
                <div className=" w-full flex flex-col items-center">
                    ...
                    <p className=" text-muted-foreground text-center text-lg">See where you stand among other learners in the community.</p>
                    <Separator className=" mb-4 h-0.5 rounded-full mt-4" />
